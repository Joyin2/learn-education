...
export default function FeaturedNewZealandUniversities() {
  ...
  useEffect(() => {
    ...
    const section = document.getElementById('featured-newzealand-universities');
    if (section) {
  ...
  return (
    <section className={styles.featuredUniversities} id="featured-newzealand-universities">
      {/* Background Effects */}
